...
function AddPopup({onsel}) {
  return (
    <section  onClick={onsel}  className="flex flex-col justify-center px-2.5 py-7 mt-4 w-full text-base tracking-tight leading-none bg-white rounded-xl border border-orange-400 border-dashed max-w-[446px] min-h-[81px] text-zinc-800 max-md:max-w-full">
